    ...
    const freebies = [
      {
        ...
        body: "คำนวณจำนวนหน้าให้พอดี 8 / 16 / 32 หน้าต่อยกพิมพ์ พร้อมส่งโรงพิมพ์ — ฟรี โดยเฉพาะกรณีพิมพ์ออฟเซ็ต เราจะเทียบจำนวนหน้าจริงของเล่มกับยกที่โรงพิมพ์ใช้ (มักเป็นทวีคูณของ 8 หรือ 16 หรือ 32 แล้วแต่เครื่อง/แบบพับ) แล้วแจ้งเป็นตัวเลขชัดเจนว่าควรเพิ่มหรือตัดกี่หน้าถึงจะลงยกพอดี เช่น เล่ม 254 หน้าอาจแนะนำ +2 เป็น 256 ให้ครบยก หรือถ้าโรงรับยก 32 อาจแนะนำปรับขึ้น/ลงให้ใกล้ยกถัดไปโดยไม่เหลือไส้กระดาษเกินจำเป็น — คุณตัดสินใจก่อนส่งไฟล์จริง",
      },
      {
        icon: "❋",
